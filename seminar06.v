...
Lemma orP_my (b c : bool) :
  reflect (b \/ c) (b || c).
Proof.
case: b ; case: c; constructor ; intuition.
Qed.
...
Proof.
case: ltngtP .
by constructor ; apply/ltnW.
by constructor ; apply/ltnW.
move=> ->.
by constructor.

Restart.
by case: ltnP=> [/ltnW|] h; constructor.
...
Proof.
by case: maxminP=> [// |_] ; rewrite addnC.
Qed.
